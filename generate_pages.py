...
new_nav = """
    <nav class="fixed top-0 w-full z-50 glass border-b border-white/5">
        ...
        <!-- Mobile Nav Dropdown -->
        <div id="mobile-menu" class="hidden md:hidden glass border-t border-white/5 px-6 py-4 flex flex-col space-y-4 text-[10px] font-bold uppercase tracking-[0.3em]">
            <a href="index.html" class="hover:text-yellow-500 transition-colors py-2">01. Hardware</a>
            <a href="ml.html" class="hover:text-cyan-400 transition-colors py-2">02. ML</a>
            <a href="agents.html" class="hover:text-green-500 transition-colors py-2">03. Agents</a>
            <a href="apps.html" class="hover:text-purple-400 transition-colors py-2">04. Apps</a>
        </div>
    </nav>
"""
